...
from dipy2.core.sphere import (Sphere, HemiSphere, unique_edges, unique_sets,
...
from dipy2.core.geometry import cart2sphere, vector_norm
from dipy2.core.sphere_stats import random_uniform_on_sphere
