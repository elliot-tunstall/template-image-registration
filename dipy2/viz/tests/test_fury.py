...
from dipy2.reconst.shm import descoteaux07_legacy_msg, sh_to_sf_matrix
from dipy2.align.tests.test_streamlinear import fornix_streamlines
from dipy2.tracking.streamline import (center_streamlines,
                                      transform_streamlines)
from dipy2.reconst.dti import color_fa, fractional_anisotropy

fury, has_fury, setup_module = optional_package('fury', min_version="0.10.0")

if has_fury:
    from dipy2.viz import actor, window, colormap
