...
from dipy2.data import read_five_af_bundles, two_cingulum_bundles
...
if have_fury:
    from dipy2.viz.streamline import (show_bundles, viz_two_bundles,
                                     viz_displacement_mag, viz_vector_field)
    from dipy2.viz import window
