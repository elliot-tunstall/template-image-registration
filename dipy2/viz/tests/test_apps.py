...
from dipy2.data import DATA_DIR
from dipy2.direction.peaks import PeaksAndMetrics
from dipy2.io.stateful_tractogram import Space, StatefulTractogram
from dipy2.io.utils import create_nifti_header
from dipy2.testing import check_for_warnings
from dipy2.testing.decorators import use_xvfb
...
if has_fury:
    ...
    from dipy2.viz.horizon.app import horizon
...
def test_horizon_events(rng):
    ...
    from dipy2.segment.tests.test_bundles import setup_module
    setup_module()
    from dipy2.segment.tests.test_bundles import f1
    streamlines = f1.copy()
...
def test_small_horizon_import():
    from dipy2.viz import horizon as Horizon
    if has_fury:
