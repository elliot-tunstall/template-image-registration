...
from dipy2 import __version__ as horizon_version
from dipy2.io.stateful_tractogram import Space, StatefulTractogram
from dipy2.io.streamline import save_tractogram
from dipy2.tracking.streamline import Streamlines
from dipy2.utils.optpkg import optional_package
from dipy2.viz.gmem import GlobalHorizon
from dipy2.viz.horizon.tab import (ClustersTab, PeaksTab, ROIsTab, SlicesTab,
                                  TabManager, build_label, SurfaceTab)
from dipy2.viz.horizon.visualizer import (ClustersVisualizer, SlicesVisualizer,
                                         SurfaceVisualizer, PeaksVisualizer)
from dipy2.viz.horizon.util import (check_img_dtype, check_img_shapes,
