...
import numpy as np
from dipy2.denoise import patch2self as p2s
from dipy2.testing import (assert_greater, assert_less,
                          assert_greater_equal, assert_less_equal)
from numpy.testing import (assert_array_almost_equal,
                           assert_raises, assert_equal)
import pytest
from dipy2.sims.voxel import multi_tensor
from dipy2.core.gradients import gradient_table, generate_bvecs
